...
# CHECK WHETHER THE DATABASE IS IN USE
...
SELECT * FROM parks_and_recreation.employee_demographics
ORDER BY age,gender; -- UNORDER BY GENDER
...
SELECT gender,SUM(age) AS sum_of_age FROM parks_and_recreation.employee_demographics
GROUP BY gender;
